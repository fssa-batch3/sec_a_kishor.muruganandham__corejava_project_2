...
public class RatingConstants {
	...
	public static final String GET_RATING_BY_BOOK_QUERY = "SELECT AVG(rating) AS average_rating, COUNT(*) AS rating_count "
			+ "FROM ratings WHERE book_id = ?";


	public static final String GET_RATING_BY_BOOK_AND_USER_QUERY = "SELECT rating FROM ratings WHERE book_id = ? AND user_id = ?";
