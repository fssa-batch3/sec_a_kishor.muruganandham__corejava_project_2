...
/**
 * This class holds constant values related to borrowing books in the library
 * management system. It provides predefined values, Error Messages and Success
 * messages.
 */
public class BorrowConstants {
	...
	// SQL query prefixes
	public static final String SELECT_QUERY_PREFIX = "SELECT user_id, book_id, borrow_date, due_date, return_date " +
			"FROM" +
			" borrows ";
	public static final String JOIN_QUERY = "SELECT b.*, u.user_name, u.user_id, u.email_id, u.profile_image,"
			+ " bk.book_id, bk.title, bk.cover_image FROM borrows b " + "JOIN users u ON b.user_id = u.user_id "
