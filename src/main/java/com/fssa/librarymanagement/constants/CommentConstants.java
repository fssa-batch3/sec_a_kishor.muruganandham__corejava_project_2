...
public class CommentConstants {
	...
	public static final String INSERT_COMMENT_QUERY = "INSERT INTO comments (user_id, book_id, description, created_at, is_trusted) "
			+ "VALUES (?, ?, ?, ?, ?)";

	public static final String UPDATE_COMMENT_QUERY = "UPDATE comments SET description = ?, edited_at = ?, is_edited = TRUE WHERE comment_id = ?";

	public static final String DELETE_COMMENT_QUERY = "UPDATE comments SET is_active = false WHERE comment_id = ?";

	public static final String BASE_COMMENT_QUERY = "SELECT c.comment_id, c.description, c.created_at, c.edited_at, c.is_active, c.is_edited,c.is_trusted, "
